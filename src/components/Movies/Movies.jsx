...
export default function Movies() {
  ...
  let getTrendingItems = async () => {
    let { data } = await axios.get
      ("https://api.themoviedb.org/3/trending/movie/week?api_key=ef9cbb095683ede3f079dfec263c76ed")
  ...
  return (
    <>
      <div className='row '>
        ...
        {movies.length > 0 ? movies.splice(0, 10).map((item, index) =>
          // hena 3mlt splice 3lshan yegbli 3adad el movies el 3ayz a3mlha view
          <div key={index} className=' col-md-2 col-sm-2 text-center py-3'>
